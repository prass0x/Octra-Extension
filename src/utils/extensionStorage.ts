...
// Override localStorage methods to use extension storage
if (typeof chrome !== 'undefined' && chrome.storage) {
  ...
  localStorage.setItem = function(key: string, value: string) {
    ...
    ExtensionStorageManager.set(key, value).catch(console.error);
  };
  ...
  localStorage.removeItem = function(key: string) {
    ...
    ExtensionStorageManager.remove(key).catch(console.error);
  };
}